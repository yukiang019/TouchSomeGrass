...
import incrementPointsby10 from './PointsUtils10';
...
const Meditate = () => {
  ...
  const startBackgroundMusic = async () => {
    try {
      const { sound } = await Audio.Sound.createAsync(
        require('/Users/yukiangmacpro/Desktop/grass-final/sounds/10mingoodful.mp3'),
  ...
  const playEndSound = async () => {
    ...
    try {
      const { sound } = await Audio.Sound.createAsync(
        require('/Users/yukiangmacpro/Desktop/grass-final/sounds/softding.mp3'),
        { shouldPlay: true }
      );
      setSound(sound);
    } catch (error) {
